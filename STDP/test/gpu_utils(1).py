...
def gpu_wrapper(input_tensor, device=0):
    ...
    gpu_process_wrapper[blockspergrid, threadsperblock](gpu_output_tensor)
...
if __name__ == '__main__':
    ...
    print(gpu_wrapper(input_tensor))
